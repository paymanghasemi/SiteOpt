...
#' \if{html}{\figure{Constraint.jpg}{}}
#' \if{latex}{\figure{Constraint.jpg}{options: width=2.0in}}\cr
#' where \eqn{B} and \eqn{S} are respectively the set of initially protected and unprotected parcels, and `b` is the right-hand-side of the constraint.
#'
#'
#'
#'
...
#'
#' @param Parcels A vector of strings: the name of the parcels to appear in the constraint. The package will automatically differentiate protected from unprotected parcels.
