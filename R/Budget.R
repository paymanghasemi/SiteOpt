...
#' \eqn{Coefficients . Parcels \le Limit}\cr
#' where `Coefficients` is a vector of doubles, `Parcels` is the vector of parcel names, and  `Limit` is a double representing the budget limit.
#'
#'
...
#'
#' @param Parcels A vector of strings: the name of the parcels appearing in the constraint.
